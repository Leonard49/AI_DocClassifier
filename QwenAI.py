...
class QwenTreeClassifier:
    ...
    # 获取方式：https://modelstudio.console.alibabacloud.com/ 控制台创建 API Key
    QWEN_API_KEY = "sk-9neu2wGxtXiOb9EcBDlL6g"   # 替换为实际 API Key
    #QWEN_BASE_URL = "https://dashscope.aliyuncs.com/compatible-mode/v1"
    QWEN_BASE_URL = "https://qlitellm.phicotek.com/v1"
    QWEN_MODEL = "qwen3.6-plus"   # 可选：qwen-turbo, qwen-plus, qwen-max, qwen-max-latest
    ...
    LABEL_TREE = {
        "Cellular": {
            ...
            "FTM":{},
            "认证":{
                "PTCRB":[], "FCC":[], "Verzion":[], "T-Mobile":[], "AT&T":[], "Vodafone":[], "Telstra":[], "Softbank":[], "SIRIM":[]
            },
            "竞品分析":{},
            "行业分析":{},
            "BB":{},
        ...
        "Automotive": {
            ...
            "接口":{},
            "功能验证":{
                "SDK Compile":[], "Sleep Mode":[], "Data Call Function":[], "USB Driver":[], "Common Peripheral Function":[],
                "Low Power Mode Issue Analysis":[], "Secboot":{"bussiness license":[]}, "ECall":[], "WI-FI Related Knowledge":[], "V2X":[], "QDR":[], "GNSS":[]
            },
            "认证":{},
            "竞品分析":{},
            "行业分析":{},
        ...
        "Smart": {
            ...
            "调试方案":{
                        "充电方案":[], 
                        "外挂模组(GNSS.Cellular/WIFI,Ethernet)":[]
                        },
        ...
        "ShortRange": {
            ...
            "抓log":[], "Log分析":[], "射频测试":[], "认证":[], "打流速率":[], "硬件原理":[], "认证":[], "竞品报告":[], "Driver bing up":[], "Host test user guide":[], "AT command":[]
            },
        ...
        "GNSS": {
            ...
            "GNSS标准协议解读":{"NEMA协议解读":[], "RTCM协议解读":[], "RINEX协议解读":[], 
        ...
        "QuecOpen": {
            ...
            "设备及网络管理":{"网络状态获取及说明":[], "网络注册步骤及常见问题分析":[], 
                             "SIM使用及管理":[]},

            "音频及语音通话":{"普通语音通话":[], "录音及播音":[], "Codec及相关及硬件":[],
                       "USB音频(UAC)":[], "音频参数调整及ACDB":[]
            },
            "电源及功耗管理":{"开关机相关":[], "低功耗应用":[], "功耗测量":[]
            },
            "常见外设接口及驱动":{"GPIO":[], "I2C/UART/SPI":[], "SDIO":[], "USB":[], "I2S":[], "SGMII":[], "设备树":[]        
            },
            "平台和系统":{"DFOTA":[], "SECURE BOOT":[], "存储及分区管理":[], "性能优化":[], "GNSS":[], "WI-FI":[], "BlueTooth":[]     
            },
            "Linux应用":{"HTTP":[], "MQTT":[], "FTP":[], "时间系统":[], "LWM2M":[], "应用日志管理":[], "QMI&MCM接口":[]
            },
            "RTOS系统及应用":{"HTTP":[], "MQTT":[], "FTP":[], "LWM2M":[], "应用日志":[]
            }
        },
        "Satellite": {
            "IoT NTN":{},
    ...
    def _build_prompt(self, user_text: str) -> str:
        ...
        - Smart:
            ...
            - 调试方案:
                    - 充电方案 
                    - 外挂模组(GNSS/Cellular/WIFI/Ethrnet)
            - System: 
                - OTA 
                - Thermal
                - SELinux
        ...
        - Satellite: IoT NTN、NR NTN、DTC/Startlink
        - Antenna
        - Services
        - Others
         ====================
    ...
    def _format_tree_description(self) -> str:
        lines = [
            ...
            "  - Flash备份还原",
            "  - Security Feature",
            "  - 通信口: UART, USB, PCIE, CMUX",
            "  - Network: LPWA Network, LTE Network, 5G Network",
            "  - SIM Card: USIM, eSIM, vSIM, iSIM",
            "  - Audio",
            "  - Voice Call",
            "  - SMS",
            "  - TCP&UDP",
            ...
            "  - 蓝牙",
            "  - FTM",
            "  - 认证: PTCRB, FCC, Verizon, T-Mobile, AT&T, Vodafone, Telstra, Softband, SIRIM",
            "  - 竞品分析",
            "  - 行业分析",
            "  - BB",
            "  - RF",
            ...
            "  - 编译",
            "  - 接口",
            "  - 功能验证: SDK Compile, Sleep Mode, Data Call Function, Common Peripheral Function, USB Driver, Low Power Mode Issue Analysis, Secboot, ECall, Data Call, WIFI Related Knowledge, V2X QDR, GNSS"
            "  - 认证",
            "  - 竞品分析",
            "  - 行业分析",
            "- Smart:",
